...
DEFAULT_FILE_STORAGE = "rosegold_v1/settings.storage_backends.MediaRootS3Boto3Storage"

STATICFILES_STORAGE = "rosegold_v1/settings.storage_backends.StaticRootS3Boto3Storage"
